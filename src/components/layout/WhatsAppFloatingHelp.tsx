...
export const WhatsAppFloatingHelp: React.FC = () => {
  ...
  return (
    <footer className="w-full relative z-10 py-3.5 sm:py-6 border-t border-slate-200/80 dark:border-slate-800/80 mt-auto bg-white/70 dark:bg-[#0a0e14]/70 backdrop-blur-xl">
      <div className="max-w-[1700px] mx-auto px-3 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-6">
        ...
        <div className="w-full sm:w-auto order-1 sm:order-2 flex items-center gap-2 sm:gap-2.5">
          ...
          <a
            ...
            className="group flex items-center justify-center px-3 sm:px-3.5 py-2.5 sm:py-2.5 rounded-xl sm:rounded-xl bg-white dark:bg-[#131823] hover:bg-slate-100 dark:hover:bg-[#1b2333] text-slate-800 dark:text-slate-100 hover:text-rose-500 dark:hover:text-rose-400 border border-slate-200 dark:border-slate-800 hover:border-rose-500/50 shadow-sm hover:shadow-[0_0_20px_rgba(244,63,94,0.25)] transition-all duration-300 cursor-pointer active:scale-95 shrink-0"
            title="Follow Fakhama Decorat on TikTok"
            aria-label="Follow Fakhama Decorat on TikTok"
          >
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg sm:rounded-lg bg-rose-500/10 dark:bg-rose-500/15 border border-rose-500/20 flex items-center justify-center text-slate-900 dark:text-white group-hover:scale-110 group-hover:bg-rose-500/25 transition-all duration-300 shadow-xs">
              <svg
                className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 fill-current"
                viewBox="0 0 24 24"
              >
          ...
          <button
            ...
            className="flex-1 sm:flex-initial group inline-flex items-center justify-between sm:justify-start gap-2 sm:gap-3 bg-white dark:bg-[#131823] hover:bg-emerald-50/70 dark:hover:bg-emerald-950/40 text-slate-800 dark:text-slate-100 hover:text-emerald-700 dark:hover:text-emerald-300 px-3 sm:px-4.5 py-2.5 sm:py-2.5 rounded-xl sm:rounded-xl border border-slate-200 dark:border-slate-800 hover:border-emerald-500/60 dark:hover:border-emerald-500/50 shadow-sm hover:shadow-[0_0_20px_rgba(16,185,129,0.25)] transition-all duration-300 cursor-pointer active:scale-98"
            aria-label="Contact us on WhatsApp for help"
          >
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              {/* Glowing emerald icon badge */}
              <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg sm:rounded-lg bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-500 dark:text-emerald-400 group-hover:scale-110 group-hover:bg-emerald-500/25 transition-all duration-300 shrink-0 shadow-xs">
                <svg
                  className="w-3.5 h-3.5 sm:w-3.5 sm:h-3.5 fill-emerald-500 dark:fill-emerald-400"
                  viewBox="0 0 24 24"
                >
            ...
            {/* Subtle mobile arrow */}
            <div className="sm:hidden text-slate-400 group-hover:text-emerald-500 transition-colors">
        ...
        <div className="space-y-0.5 sm:space-y-1 text-center sm:text-left rtl:sm:text-right order-2 sm:order-1">
          <p className="text-[11px] sm:text-xs font-semibold text-slate-700 dark:text-slate-300">
            {t('brand.tagline')}
          </p>
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-1.5 sm:gap-x-2 gap-y-0.5 text-[10px] sm:text-[11px] text-slate-400 dark:text-slate-500">
